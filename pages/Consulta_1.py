...
st.write("""Neste gráfico de barras é representada a quantidade de estudantes matriculados 
         em escolas do Recife que participaram do ENEM ao longo dos anos. O eixo X 
         representa os anos e o eixo Y representa a quantidade de participantes.""")
